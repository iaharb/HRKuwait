    ...
    <div className="space-y-12 animate-in fade-in duration-700 pb-20 text-start">
          ...
          {report && (
            <div className="bg-white/5 backdrop-blur-3xl p-10 rounded-[48px] border border-white/10 space-y-8 animate-in zoom-in-95 duration-500 shadow-2xl">
              <div className="flex items-center justify-between">
                ...
                <span className={`px-5 py-2 rounded-xl text-[10px] font-black uppercase tracking-[0.15em] ${report.complianceStatus === 'Compliant' ? 'bg-indigo-500/20 text-indigo-400 border border-indigo-500/30' :
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white p-12 rounded-[56px] border border-slate-200 shadow-sm hover:shadow-xl transition-all group">
          ...
          <div className="flex items-end gap-4 text-start">
            <h4 className="text-6xl font-black text-slate-900 tracking-tighter">
              {overallLateRate}%
            </h4>
            <span className={`text-xs font-black mb-2 uppercase tracking-widest ${overallLateRate > 10 ? 'text-rose-500' : 'text-emerald-500'}`}>
              {overallLateRate > 10 ? 'High Variance' : 'On Track'}
            </span>
          </div>
        </div>
