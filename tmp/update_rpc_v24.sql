-- Sentinel V24: The 'Bilingual Detail Sovereign'
-- 1. Precision Day-Token check to skip settled days.
-- 2. Granular breakdown: Days Worked, Leave Base, and Leave Housing are split (Excel logic).
-- 3. PIFSS De-duplication: Checks for previous deductions in current month.
-- 4. Mandatory Details: Always shows the core components for transparency.
...
BEGIN
    ...
    SELECT 
        ...
        -- GRANULAR EARNINGS BREAKDOWN (Restored per user request)
